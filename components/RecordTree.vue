<template>
  <div class="relative inline-block sm:left-[50%] sm:-translate-x-[100%]">
    <p class="relative md:-left-6 md:translate-x-[100%]">百岳經歷</p>
    ...
    <ul class="mt-3 ml-6 inline-block pt-10 sm:ml-0 sm:pt-12">
      ...
      >
        <!-- :class="(idx + 1) % 2 === 1 ? 'rotate-y-[180deg]' : ''" -->

        <div
          class="absolute bottom-0 left-[7px] h-[calc(100%+42px)] w-[6px] self-start rounded-full bg-white"
        ></div>
        ...
        <div class="flex items-center self-start">
          ...
          ></div>
          <div class="h-[1px] w-[100px] bg-yellow sm:w-[150px]"></div>
          <p
